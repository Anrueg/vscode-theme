...
function theme(theme: Theme) {
    ...
    const tokens: Schema = normalizeTokens({
        ...
        propertyDef: { foreground: punctuation },
        ...
        functionDef: { foreground: cyanish },
        functionRef: { foreground: cyanish },
        paramDef: { foreground: violetish },
        paramRef: { foreground: violetish },
    ...
    return {
        ...
        colors: {
            ...
            // "editorGhostText.border": alpha(cyanish, 0.1),
...
function semanticTokens(schema: Schema) {
    return {
        ...
        "class.decorator": schema.decorator,
        ...
        "method.decorator": schema.decorator,
